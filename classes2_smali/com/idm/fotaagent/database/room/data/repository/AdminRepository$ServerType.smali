...
# static fields
.field private static final $VALUES:[Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;
...
.method private static synthetic $values()[Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;
    ...
    new-array v0, v0, [Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;

    const/4 v1, 0x0

    sget-object v2, Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;->PRODUCTION_SERVER:Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;

    aput-object v2, v0, v1

    const/4 v1, 0x1

    sget-object v2, Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;->STAGING_SERVER:Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "PRODUCTION_SERVER"

    const/4 v2, 0x0

    const-string v3, "Production server"

    invoke-direct {v0, v1, v2, v3}, Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string v1, "STAGING_SERVER"

    const/4 v2, 0x1

    const-string v3, "Staging server"
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/idm/fotaagent/database/room/data/repository/AdminRepository$ServerType;->description:Ljava/lang/String;
