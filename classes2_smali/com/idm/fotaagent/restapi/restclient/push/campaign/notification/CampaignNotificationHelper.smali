...
.method public cancel()V
    ...
    iget-object v0, p0, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/CampaignNotificationHelper;->context:Landroid/content/Context;
    ...
    :cond_12
    sget-object v1, Lcom/idm/fotaagent/enabler/ui/notification/manager/NotificationId;->NOTIFICATION_ID_CAMPAIGN:Lcom/idm/fotaagent/enabler/ui/notification/manager/NotificationId;

    invoke-virtual {v1}, Lcom/idm/fotaagent/enabler/ui/notification/manager/NotificationId;->getId()I

    move-result v1

    invoke-virtual {v0, v1}, Landroid/app/NotificationManager;->cancel(I)V

    const-string v0, "Cancel campaign notification"
...
.method public getStrategy(Ljava/util/List;)Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy;
    ...
    invoke-direct {v0, v1, p1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy$BigTextStyle;-><init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    invoke-direct {v0, v1, p1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy$InboxStyle;-><init>(Landroid/content/Context;Ljava/util/List;)V
...
.method public notifyNotification()V
    ...
    const-string v0, "there are no campaign messages"
    ...
    invoke-virtual {v2, v3, v6}, Landroid/app/Notification$Builder;->setFlag(IZ)Landroid/app/Notification$Builder;

    move-result-object v2

    invoke-virtual {p0, v1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/CampaignNotificationHelper;->getStrategy(Ljava/util/List;)Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy;

    move-result-object v1

    invoke-virtual {v1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy;->getTitle()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    invoke-virtual {v1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy;->getText()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    invoke-virtual {v1}, Lcom/idm/fotaagent/restapi/restclient/push/campaign/notification/NotificationBuilderStrategy;->getStyle()Landroid/app/Notification$Style;
    ...
    const-string v0, "Add Campaign Notification"
