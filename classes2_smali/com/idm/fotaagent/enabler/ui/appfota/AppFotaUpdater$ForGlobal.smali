...
.method public getContentValues()Landroid/content/ContentValues;
    ...
    invoke-interface {v0, v2}, Lcom/idm/fotaagent/enabler/ui/whatsnew/MajorUpdate;->isMajorUpdate(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_2f

    const-string v0, "oneui_version"
...
.method public setContentValues(Landroid/content/ContentValues;)V
    ...
    const-string v1, "content://com.samsung.android.app.updatecenter.provider/target"
    ...
    const-string v1, "Uri resulting from insert should not be null"

    invoke-static {v0, v1}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;

    const-string v0, "succeeded to inform Global AppUpdateCenter"
    ...
    const-string v2, "failed to inform Global AppUpdateCenter\n"
