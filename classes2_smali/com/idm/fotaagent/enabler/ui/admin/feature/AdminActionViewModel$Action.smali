...
# static fields
.field private static final $VALUES:[Lcom/idm/fotaagent/enabler/ui/admin/feature/AdminActionViewModel$Action;
...
.method private static synthetic $values()[Lcom/idm/fotaagent/enabler/ui/admin/feature/AdminActionViewModel$Action;
    ...
    new-array v0, v0, [Lcom/idm/fotaagent/enabler/ui/admin/feature/AdminActionViewModel$Action;
...
.method private static initiatePush(Lcom/idm/fotaagent/database/sqlite/database/mo/push/field/UiMode;)V
    ...
    const-string v0, "releaseServerInfo should not be null"
    ...
    const-string v0, "serverId should not be null"
    ...
    invoke-virtual {v0}, Lcom/idm/fotaagent/database/sqlite/database/mo/push/DmNotificationRawData$Builder;->build()Lcom/idm/fotaagent/database/sqlite/database/mo/push/DmNotificationRawData;

    move-result-object v0

    invoke-virtual {v0}, Lcom/idm/fotaagent/database/sqlite/database/mo/push/DmNotificationRawData;->generate()[B

    move-result-object v0

    new-instance v1, Ljava/lang/StringBuilder;

    const-string v2, "notiData : "
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/scheduler/SchedulerInitiator;->initiateByServer([B)V
