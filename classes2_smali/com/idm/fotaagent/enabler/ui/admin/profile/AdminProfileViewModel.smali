...
.method public constructor <init>(Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;)V
    ...
    iput-object v2, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->serverUrl:Landroidx/lifecycle/F;

    new-instance v3, Landroidx/lifecycle/F;

    invoke-direct {v3}, Landroidx/lifecycle/F;-><init>()V

    iput-object v3, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->serverId:Landroidx/lifecycle/F;

    new-instance v4, Landroidx/lifecycle/F;

    invoke-direct {v4}, Landroidx/lifecycle/F;-><init>()V

    iput-object v4, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->serverPwd:Landroidx/lifecycle/F;

    new-instance v5, Landroidx/lifecycle/F;

    invoke-direct {v5}, Landroidx/lifecycle/F;-><init>()V

    iput-object v5, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->clientId:Landroidx/lifecycle/F;

    new-instance v6, Landroidx/lifecycle/F;

    invoke-direct {v6}, Landroidx/lifecycle/F;-><init>()V

    iput-object v6, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->clientPwd:Landroidx/lifecycle/F;

    new-instance v7, Landroidx/lifecycle/F;

    invoke-direct {v7}, Landroidx/lifecycle/F;-><init>()V

    iput-object v7, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->serverAuthTypeIndex:Landroidx/lifecycle/F;

    new-instance v8, Landroidx/lifecycle/F;

    invoke-direct {v8}, Landroidx/lifecycle/F;-><init>()V

    iput-object v8, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->clientAuthTypeIndex:Landroidx/lifecycle/F;

    new-instance v9, Landroidx/lifecycle/F;

    invoke-direct {v9}, Landroidx/lifecycle/F;-><init>()V

    iput-object v9, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->toastMessageId:Landroidx/lifecycle/F;
    ...
    invoke-virtual {v7, v0}, Landroidx/lifecycle/C;->k(Ljava/lang/Object;)V
    ...
    invoke-virtual {v8, v0}, Landroidx/lifecycle/C;->k(Ljava/lang/Object;)V
...
.method private getPortFrom(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_end_19
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_19} :catch_22
...
.method private isEmptyText()Z
    ...
    iget-object v0, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->clientPwd:Landroidx/lifecycle/F;
...
.method private isSameDBTable(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoIsSameMoDBTable(Ljava/lang/String;)Z
...
.method private replaceServerIdEnablerProfileTable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseManager;->idmChangeServerIdProfileName(Ljava/lang/String;Ljava/lang/String;)V
...
.method private replaceServerIdMoProfileTable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoChangeServerIdProfileTable(Ljava/lang/String;Ljava/lang/String;)V
...
.method private replaceServerIdMoProfileTableName(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoChangeServerIdProfileTableName(Ljava/lang/String;Ljava/lang/String;)V
...
.method private replaceServerIdMoXNodeName(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoChangeServerIdXNodeName(Ljava/lang/String;Ljava/lang/String;)V
...
.method private replaceServerIdMoXfumoTable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoChangeServerIdXfumoTable(Ljava/lang/String;Ljava/lang/String;)V
...
.method private replaceServerIdMoXnodeTable(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoChangeServerIdXnodeTable(Ljava/lang/String;Ljava/lang/String;)V
...
.method private saveProfileToDB()Z
    ...
    :try_start_0
    iget-object v1, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->profile:Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetName(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetServerUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetServerId(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetServerPwd(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->profile:Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;

    iget-object v2, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->authTypes:Ljava/util/List;

    iget-object v0, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->serverAuthTypeIndex:Landroidx/lifecycle/F;
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetServerAuthtype(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetClientId(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetClientPwd(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->profile:Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;

    iget-object v2, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->authTypes:Ljava/util/List;

    iget-object v0, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->clientAuthTypeIndex:Landroidx/lifecycle/F;
    ...
    invoke-virtual {v1, v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->idmSetClientAuthtype(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/samsung/android/fotaagent/common/log/Log;->I(Ljava/lang/Object;)V
    :try_end_94
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_94} :catch_96
    .catch Lcom/idm/providers/mo/exception/IDMMoExceptionNotFound; {:try_start_0 .. :try_end_94} :catch_9c
...
.method private setServerInfo(Lcom/idm/fotaagent/database/sqlite/database/IDMDatabaseProfile;)V
    ...
    invoke-virtual {v0, v4, v1, v2, v3}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoSetAccAuthInfo(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v1, v2, v3}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoSetAccAuthInfo(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/idm/providers/mo/IDMMoDatabaseManager;->idmMoSetAppAddrPortInfo(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getAuthTypes()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->authTypes:Ljava/util/List;
...
.method public getToastMessageId()Landroidx/lifecycle/F;
    ...
    iget-object v0, p0, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->toastMessageId:Landroidx/lifecycle/F;
...
.method public saveProfileToDBIfPossible()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdMoXfumoTable(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdMoXnodeTable(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdMoXNodeName(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdMoProfileTable(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdMoProfileTableName(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v1, v0}, Lcom/idm/fotaagent/enabler/ui/admin/profile/AdminProfileViewModel;->replaceServerIdEnablerProfileTable(Ljava/lang/String;Ljava/lang/String;)V
