...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/idm/fotaagent/scheduler/f;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lcom/idm/fotaagent/scheduler/f;-><init>(I)V
...
.method private static synthetic lambda$static$0(Lcom/idm/fotaagent/scheduler/IDMSchedulerInfo;)Lcom/idm/service/actioninfo/IDMActionInfo;
    ...
    invoke-virtual {v2}, Lcom/idm/fotaagent/database/sqlite/database/mo/push/field/UiMode;->toCode()B

    move-result v2

    invoke-virtual {v1, v2}, Lcom/idm/service/actioninfo/IDMActionInfo;->idmSetPushUiMode(I)V
    ...
    invoke-interface {v2, v3}, Lcom/idm/providers/mo/IDMMoDatabaseAdapter;->idmMoGetXnodeInfo(Ljava/lang/String;)Lcom/idm/providers/mo/IDMMoXnodeInfo;

    move-result-object v2

    invoke-virtual {v2}, Lcom/idm/providers/mo/IDMMoXnodeInfo;->idmMoGetxFumo()Ljava/lang/String;
    ...
    :cond_57
    new-instance v2, Lcom/idm/fotaagent/database/room/data/repository/DmNotificationRepository;

    invoke-static {}, Lcom/idm/fotaagent/IDMApplication;->idmGetContext()Landroid/content/Context;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/idm/fotaagent/database/room/data/repository/DmNotificationRepository;-><init>(Landroid/content/Context;)V

    invoke-virtual {v2, v0}, Lcom/idm/fotaagent/database/room/data/repository/DmNotificationRepository;->save(Lcom/idm/fotaagent/database/sqlite/database/mo/push/DmNotificationMessage;)V
...
.method private static synthetic lambda$static$1(Lcom/idm/fotaagent/scheduler/IDMSchedulerInfo;)Lcom/idm/service/actioninfo/IDMActionInfo;
    ...
    invoke-virtual {v2, v3}, Lcom/idm/service/actioninfo/IDMActionInfo;->idmSetServerId(Ljava/lang/String;)V

    const-string v3, "334d"

    invoke-virtual {v2, v3}, Lcom/idm/service/actioninfo/IDMActionInfo;->idmSetSessionId(Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v0}, Lcom/idm/service/actioninfo/IDMActionInfo;->idmSetAlertCommandNode(Ljava/lang/String;)V
